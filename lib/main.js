...
class Config {
    ...
    constructor(name, opts) {
        ...
        this.writeStream.on('error', handleWriteError)
    ...
    write(data) {
        if (!this.writeStream) throw new ConfigWriteError('Stream not initialized')
        ...
        switch (typeof data) {
            case 'string':
                ...
                break
            case 'object':
                this.writeStream.write(JSON5.stringify(data))
                break
            default:
